...
//float waypoint_x[16] = {0.0,   0.0, -390.0,   0.0, 210.0, LAST_ELEM};
//float waypoint_y[16] = {0.0, 320.0,  390.0,  50.0, 210.0, LAST_ELEM};

float waypoint_x[16] = {0.0,   0.0, -390.0, -390.0, -600.0, LAST_ELEM};
float waypoint_y[16] = {0.0, 320.0,  320.0,  270.0,  270.0, LAST_ELEM};
